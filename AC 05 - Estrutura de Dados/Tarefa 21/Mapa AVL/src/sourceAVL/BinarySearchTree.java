...
// Passo 3:
// Faça a o filho esquerdo de b e T0 e T1 as subárvores esquerda e direita de a, respectivamente.
        b.setLeft(a);
        a.setParent(b);
        a.setLeft(t0);
        t0.setParent(a);
        ...
        t1.setParent(a);
// Passo 4:
// Faça c o filho direito de b e T2 e T3 as subárvores esquerda e direita de c, respectivamente.
        b.setRight(c);
        c.setParent(b);
        c.setLeft(t2);
        t2.setParent(c);
